<?php if($loginstat != 1){echo "<script>location.href='".base_url()."'</script>";}?>
...
<div id="body">
  ...
  <div id="propreview">
    <table width="100%">
      ...
      <tr>
        <td class="tablerow">Jumlah Beli</td>
        <td>
          <input type="number" name="qty" value="0" min="0" class="txt">
        </td>
      </tr>
      <tr>
        <td>&nbsp;</td>
