		...
		<div class="tab_container">
				...
				<tbody>
					...
					<!--
						...
						var goifokay = "<?php echo base_url().'adminpanel/transaction/archive_transaction/'.$rows->id_order;?>";
				    ...
				    <?php
								...
								if($rows->status_order ==1){
                                echo "<td><a href='".base_url()."adminpanel/transaction/edit_status_member/".$rows->id_order."' title=\"Change Transaction's Status\"><input type=\"image\" src='".base_url()."asset/images/theme/admintheme/icn_edit.png'></a>";
								...
								echo "<td><a href='".base_url()."adminpanel/transaction/edit_status_member/".$rows->id_order."' title=\"Change Transaction's Status\"><input type=\"image\" src='".base_url()."asset/images/theme/admintheme/icn_edit.png'></a></td>";
								}
                                echo "</tr>";
								}
                        }
				...
				<a href="<?php echo base_url('adminpanel/report/order_member')?>"><input type="submit" value="Print Report" class="alt_btn"></a>
				</div>
		</div>
</article>
