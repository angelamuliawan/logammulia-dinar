		...
		<div class="tab_container">
				...
				<tbody>
					...
					<!--
						...
						var goifokay = "<?php echo base_url().'adminpanel/transaction/delete_confirmation_nonmember/'.$rows->id_order;?>";
				    ...
				    <?php
                                ...
                                echo "<td><a href='".base_url()."adminpanel/transaction/edit_confirmation_nonmember/".$rows->id_order_nonmember."' title=\"Change Transaction's Status\"><input type=\"image\" src='".base_url()."asset/images/theme/admintheme/icn_edit.png'></a></td>";
                                echo "</tr>";
								}
                        }
