...
<div id="searchbox">
  <table width="90%" border="1">
      ...
      <strong><em style="color:white">Quick results <a href="#" onclick="setSearchBox('none')">[Close]</a></em></strong>    
    </th>
    <tr>
      <td width="81%" id="searchresult"></td>
    </tr>
    <th colspan="2"><br>
    <a style="color:white" href="#" onclick="document.forms['searchform'].submit()"> View all results </a>   
    </th>
  </table>
</div>