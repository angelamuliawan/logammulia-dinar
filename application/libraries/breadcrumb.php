...
*
*/
private $_divider = '<div class="breadcrumb_divider"></div>';
private $_tag_open = '<article class="breadcrumbs">';
private $_tag_close = '</article>';
private $_item_open	= '';
private $_item_close	= '';
private $_last_item_open = "<a class='current'>";
private $_last_item_close = "</a>";
